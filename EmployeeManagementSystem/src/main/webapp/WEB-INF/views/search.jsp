...
<body>
    ...
    <script>
        function showSection(sectionId) {
            ...
            const backgrounds = {
            		home: 'url("https://img.freepik.com/free-vector/office-interior-open-space-flat-design-vector-illustration-businessmen-talking-modern-meeting-room-conference-hall_126523-3102.jpg?semt=ais_hybrid&w=740&q=80")',

            	    registration: 'url("https://img.freepik.com/free-photo/blue-stationery-table_23-2148169490.jpg")',
